...
then
    ...
    java -jar revanced-cli.jar -m revanced-integrations.apk -b revanced-patches.jar -i minimized-playback -i disable-create-button -i premium-heading -i custom-branding -i disable-shorts-button -i old-quality-layout -i hide-cast-button -i general-ads -i video-ads -i seekbar-tapping -i upgrade-button-remover -i tasteBuilder-remover -i background-play -i exclusive-audio-playback -i codecs-unlock \
